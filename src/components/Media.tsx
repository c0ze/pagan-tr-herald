      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-muted-foreground mb-12">
            Visual and sonic darkness
          </p>

          {/* Featured Video */}
          <div className="mb-16">
            <div className="aspect-video w-full max-w-4xl mx-auto border-2 border-primary/30 border-glow">
              <iframe
                width="100%"
                height="100%"
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold group-hover:text-primary transition-colors">YouTube</h3>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold group-hover:text-primary transition-colors">Facebook</h3>
